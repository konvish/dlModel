...
public class MalmoEnv implements MDP<MalmoBox, Integer, DiscreteSpace> {
    ...
    public void setObservationSpace(MalmoObservationSpace observationSpace) {
        this.observationSpace = observationSpace;
    }

    public void setActionSpace(MalmoActionSpace actionSpace) {
        this.actionSpace = actionSpace;
    }

    public MalmoResetHandler getResetHandler() {
        return resetHandler;
    }
    ...
    public static String readFile(String fileName) throws IOException {
        InputStream resourceAsStream = MalmoEnv.class.getClassLoader().getResourceAsStream(fileName);
    ...
    @Override
    public ObservationSpace<MalmoBox> getObservationSpace() {
